...
class CrimsonClericModel(root: ModelPart) : AbstractCrimsonModel<CrimsonClericEntity>(root) {
    ...
    override fun prepareMobModel(entity: CrimsonClericEntity, limbSwing: Float, limbSwingAmount: Float, partialTick: Float) {
    ...
    companion object {
        ...
        val LAYER_LOCATION: ModelLayerLocation =
            ModelLayerLocation(VoidBound.id("crimson_cleric"), "main")
