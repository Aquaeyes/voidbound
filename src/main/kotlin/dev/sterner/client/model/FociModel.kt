...
class FociModel(val root: ModelPart) : Model(Function { location: ResourceLocation ->
    ...
    companion object {
        ...
        val LAYER_LOCATION: ModelLayerLocation = ModelLayerLocation(VoidBound.id("foci"), "main")
