...
class CrimsonHeavyKnightModel(root: ModelPart) : AbstractCrimsonModel<CrimsonHeavyKnightEntity>(root) {
    ...
    override fun prepareMobModel(entity: CrimsonHeavyKnightEntity, limbSwing: Float, limbSwingAmount: Float, partialTick: Float) {
