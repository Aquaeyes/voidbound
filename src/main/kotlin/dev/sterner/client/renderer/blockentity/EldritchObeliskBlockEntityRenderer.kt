...
class EldritchObeliskBlockEntityRenderer(ctx: BlockEntityRendererProvider.Context) :
    ...
    override fun render(
        ...
        coreModel.renderToBuffer(poseStack, buffer.getBuffer(RenderType.endPortal()), packedLight, packedOverlay, 1f, 1f, 1f, 1f)
        mainModel.renderToBuffer(poseStack, buffer.getBuffer(RenderType.entityTranslucent(VoidBound.id("textures/block/obelisk.png"))), packedLight, packedOverlay, 1f, 1f, 1f, 1f)
