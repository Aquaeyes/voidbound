...
class SelectedEnchantmentWidget(screen: OsmoticEnchanterScreen, x: Int, y: Int) : EnchantmentWidget(screen, x, y, 22, 39) {
    ...
    override fun onClick(mouseX: Double, mouseY: Double) {
        ...
        // Area 2: y[30,36] & x[6,10]
        val area2XStart: Double = x + 6.0
        val area2XEnd: Double = x + 16.0
        val area2YStart: Double = y + 30.0
        val area2YEnd: Double = y + 36.0

        // Area 3: y[7,29] & x[0,22]
        val area3XStart: Double = x.toDouble()
        val area3XEnd: Double = x + 22.0
        val area3YStart: Double = y + 7.0
        val area3YEnd: Double = y + 29.0
        println(y - mouseY)
        when {
    ...
    override fun renderWidget(guiGraphics: GuiGraphics, mouseX: Int, mouseY: Int, partialTick: Float) {
        ...
        guiGraphics.blit(border, x, y, 0f,0f,22, 39, 22, 39)
