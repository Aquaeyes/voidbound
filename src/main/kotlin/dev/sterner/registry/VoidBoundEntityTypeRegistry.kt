...
object VoidBoundEntityTypeRegistry {
    var ENTITY_TYPES: LazyRegistrar<EntityType<*>> = LazyRegistrar.create(BuiltInRegistries.ENTITY_TYPE, VoidBound.modid)
    ...
    var SOUL_STEEL_GOLEM_ENTITY: RegistryObject<EntityType<SoulSteelGolemEntity>> = ENTITY_TYPES.register("soul_steel_golem") {
    ...
    var CRIMSON_KNIGHT_ENTITY: RegistryObject<EntityType<CrimsonKnightEntity>> = ENTITY_TYPES.register("crimson_knight") {
    ...
    var CRIMSON_ARCHER_ENTITY: RegistryObject<EntityType<CrimsonArcherEntity>> = ENTITY_TYPES.register("crimson_archer") {
    ...
    var CRIMSON_CLERIC_ENTITY: RegistryObject<EntityType<CrimsonClericEntity>> = ENTITY_TYPES.register("crimson_cleric") {
    ...
    var CRIMSON_NECROMANCER_ENTITY: RegistryObject<EntityType<CrimsonNecromancerEntity>> = ENTITY_TYPES.register("crimson_necromancer") {
    ...
    var CRIMSON_HEAVY_KNIGHT_ENTITY: RegistryObject<EntityType<CrimsonHeavyKnightEntity>> = ENTITY_TYPES.register("crimson_heavy_knight") {
    ...
    var CRIMSON_JESTER_ENTITY: RegistryObject<EntityType<CrimsonJesterEntity>> = ENTITY_TYPES.register("crimson_jester") {
