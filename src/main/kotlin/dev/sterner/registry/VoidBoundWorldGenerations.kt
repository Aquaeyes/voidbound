...
object VoidBoundWorldGenerations {
    ...
    val TEAR_OF_CRIMSON = TearOfCrimsonFeature(NoneFeatureConfiguration.CODEC)
    val TEAR_OF_CRIMSON_ID = VoidBound.id("tear_of_crimson")
    val TEAR_OF_CRIMSON_FEATURE: ResourceKey<PlacedFeature> = registerKey("tear_of_crimson")
